...
SWIFT_AVAILABILITY(visionos,introduced=26.0) SWIFT_AVAILABILITY(tvos,introduced=26.0) SWIFT_AVAILABILITY(macos,introduced=26.0) SWIFT_AVAILABILITY(ios,introduced=26.0)
@interface GKWLocalPlayerListener (SWIFT_EXTENSION(GameKitWrapper)) <GKGameActivityListener>
- (void)player:(GKPlayer * _Nonnull)player wantsToPlayGameActivity:(GKGameActivity * _Nonnull)activity completionHandler:(void (^ _Nonnull)(BOOL))completion;
@end
